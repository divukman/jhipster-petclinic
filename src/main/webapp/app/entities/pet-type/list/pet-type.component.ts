...
export class PetTypeComponent implements OnInit {
  ...
  trackId(index: number, item: IPetType): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IPetType[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
