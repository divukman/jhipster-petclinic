...
import tech.dimitar.jhipster.petclinic.service.VetQueryService;
import tech.dimitar.jhipster.petclinic.service.VetService;
import tech.dimitar.jhipster.petclinic.service.criteria.VetCriteria;
...
/**
 * REST controller for managing {@link tech.dimitar.jhipster.petclinic.domain.Vet}.
 */
@RestController
@RequestMapping("/api")
public class VetResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/vets/{id}", consumes = "application/merge-patch+json")
