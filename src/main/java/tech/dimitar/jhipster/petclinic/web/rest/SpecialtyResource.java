...
import tech.dimitar.jhipster.petclinic.repository.SpecialtyRepository;
import tech.dimitar.jhipster.petclinic.service.SpecialtyService;
...
/**
 * REST controller for managing {@link tech.dimitar.jhipster.petclinic.domain.Specialty}.
 */
@RestController
@RequestMapping("/api")
public class SpecialtyResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/specialties/{id}", consumes = "application/merge-patch+json")
