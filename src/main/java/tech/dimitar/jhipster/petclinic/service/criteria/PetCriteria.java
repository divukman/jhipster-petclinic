...
/**
 * Criteria class for the {@link tech.dimitar.jhipster.petclinic.domain.Pet} entity. This class is used
 * in {@link tech.dimitar.jhipster.petclinic.web.rest.PetResource} to receive all the possible filtering options from
...
public class PetCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, birthDate, visitsId, typeId, ownerId);
    }
