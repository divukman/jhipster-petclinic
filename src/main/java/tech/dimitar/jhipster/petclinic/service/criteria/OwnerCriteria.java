...
/**
 * Criteria class for the {@link tech.dimitar.jhipster.petclinic.domain.Owner} entity. This class is used
 * in {@link tech.dimitar.jhipster.petclinic.web.rest.OwnerResource} to receive all the possible filtering options from
...
public class OwnerCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, firstName, lastName, address, city, telephone, petsId);
    }
