...
import tech.dimitar.jhipster.petclinic.service.criteria.OwnerCriteria;
...
class OwnerResourceIT {
    ...
    @Test
    @Transactional
    void getAllOwnersByFirstNameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        ownerRepository.saveAndFlush(owner);
    ...
    @Test
    @Transactional
    void getAllOwnersByLastNameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        ownerRepository.saveAndFlush(owner);
    ...
    @Test
    @Transactional
    void getAllOwnersByAddressIsNotEqualToSomething() throws Exception {
        // Initialize the database
        ownerRepository.saveAndFlush(owner);
    ...
    @Test
    @Transactional
    void getAllOwnersByCityIsNotEqualToSomething() throws Exception {
        // Initialize the database
        ownerRepository.saveAndFlush(owner);
    ...
    @Test
    @Transactional
    void getAllOwnersByTelephoneIsNotEqualToSomething() throws Exception {
        // Initialize the database
        ownerRepository.saveAndFlush(owner);
    ...
    void partialUpdateOwnerWithPatch() throws Exception {
        ...
        partialUpdatedOwner.lastName(UPDATED_LAST_NAME).telephone(UPDATED_TELEPHONE);
